...
from src.efficient_frontier import optimize_portfolio
...
def main():
    ...
    # Keep the order of stocks consistent
    ...
    best_portfolio = get_max_sharpe_portfolio(portfolios)

    lowest_risk_portfolio = get_min_risk_portfolio(portfolios)
